...
<section><h2>E-mailuri trimise</h2><table class='email-table'><tr><th>Moment</th><th>Destinatari</th><th>Subiect</th><th>Conținut</th></tr>{email_rows}</table></section></html>"""
        body = page.encode()
